...
public final class Configuration {
     ...
     * <p>
     * If the properties map contains the string, but the string is empty by
     * {@link String#isEmpty()}, then also the default value will be returned.
     * </p>
     *
     * @param properties
     *            the properties to read from, may be {@code null}
     ...
     * @param key
     *            the key to fetch
     * @return the boolean value from the configuration, or {@code false} if the
     *         property set is {@code null}, the property is not set or it is not
     *         boolean
     */
    public static boolean asBoolean(final Map<String, ?> properties, final String key) {
        return asBoolean(properties, key, false);
    }

    public static Boolean asBoolean(final Map<String, ?> properties, final String key, final Boolean defaultValue) {
        if (properties == null) {
            return defaultValue;
        }
